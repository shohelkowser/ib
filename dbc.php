...
while ($row = $sql_data->fetch_object()) {
    ...
    echo "<tr><th id='idno' scope='row'>" . $id . "</th>";
    echo "<td class='tdedit' columname='name'>" . $name . "</td>";
    echo "<td class='tdedit'  columname='price'>" . $price . "</td>";
    echo "<td class='tdedit' columname='details'><div class='scroll'>" . $details . "</div></td>";
    echo "<td class='tdedit'  columname='brand'>" . $brand . "</td>";
    echo "<td class='tdedit'  columname='model'>" . $model . "</td>";
    if ($quantity < 1) {
        echo "<td class='label-danger tdedit' columname='quantity'><div style='display: flex;justify-content: center;'><h1>" . $quantity . "</h1></div></td>";
    } else {
        echo "<td class='tdedit' columname='quantity'>" . $quantity . "</td>";
    }
